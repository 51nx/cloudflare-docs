...
| Control objective | What it requires | How client-side security addresses it |
| --- | --- | --- |
| Header tamper detection | Detect unauthorized changes to HTTP security headers | Alerts fire when monitored scripts, connections, or cookies on a payment page change unexpectedly. Refer to the [PCI DSS v4.0 Evaluation](https://cfl.re/4dhk8Gx) whitepaper for the full requirement mapping |
